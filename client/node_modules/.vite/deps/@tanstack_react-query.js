...
function dehydratePromise(query, serializeData, shouldRedactErrors) {
  ...
  const promise = (_a13 = query.promise) == null ? void 0 : _a13.then(serializeData).catch((error) => {
    if ((shouldRedactErrors == null ? void 0 : shouldRedactErrors(error)) === false)
...
function hydrate(client, dehydratedState, options) {
  ...
  (_d = dehydratedState.queries) == null ? void 0 : _d.forEach(({ queryKey, state, queryHash, meta, promise, dehydratedAt, queryType }) => {
    ...
    if (promise && !syncData && !existingQueryIsPending && !existingQueryIsFetching && (dehydratedAt === void 0 || dehydratedAt > query.state.dataUpdatedAt))
...
var _queryType, _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _dispatch, dispatch_fn, _a5;
var Query = (_a5 = class extends Removable {
    ...
    if (index !== -1) {
      ...
      if (!this.observers.length) {
        if (__privateGet(this, _retryer)) {
          if (__privateGet(this, _abortSignalConsumed) || this.state.fetchStatus === "paused" && this.state.status === "pending")
  ...
  async fetch(options, fetchOptions) {
    ...
    try {
      ...
      if (__privateGet(this, _retryer) === retryer)
        __privateSet(this, _retryer, void 0);
      this.scheduleGc();
    }
  }
}, _queryType = new WeakMap(), _initialState = new WeakMap(), _revertState = new WeakMap(), _cache = new WeakMap(), _client = new WeakMap(), _retryer = new WeakMap(), _defaultOptions = new WeakMap(), _abortSignalConsumed = new WeakMap(), _dispatch = new WeakSet(), dispatch_fn = function(action) {
  const reducer = (state) => {
    switch (action.type) {
      case "failed":
        return {
...
var _client2, _currentQuery, _currentQueryInitialState, _currentResult, _currentResultState, _currentResultOptions, _selectError, _selectFn, _selectResult, _lastQueryWithDefinedData, _staleTimeoutId, _refetchIntervalId, _currentRefetchInterval, _trackedProps, _executeFetch, executeFetch_fn, _shouldScheduleTimer, shouldScheduleTimer_fn, _updateStaleTimeout, updateStaleTimeout_fn, _computeRefetchInterval, computeRefetchInterval_fn, _updateRefetchInterval, updateRefetchInterval_fn, _updateTimers, updateTimers_fn, _clearStaleTimeout, clearStaleTimeout_fn, _clearRefetchInterval, clearRefetchInterval_fn, _updateQuery, updateQuery_fn, _a6;
var QueryObserver = (_a6 = class extends Subscribable {
  constructor(client, options) {
    super();
    __privateAdd(this, _executeFetch);
    __privateAdd(this, _shouldScheduleTimer);
  ...
  setOptions(options) {
    ...
    if (this.options.enabled !== void 0 && typeof this.options.enabled !== "boolean" && typeof this.options.enabled !== "function" && typeof resolveQueryValue(this.options.enabled, __privateGet(this, _currentQuery)) !== "boolean")
    ...
    if (mounted && (__privateGet(this, _currentQuery) !== prevQuery || resolveQueryValue(this.options.enabled, __privateGet(this, _currentQuery)) !== resolveQueryValue(prevOptions.enabled, __privateGet(this, _currentQuery)) || nextRefetchInterval !== __privateGet(this, _currentRefetchInterval)))
  ...
  createResult(query, options) {
    ...
    if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
      ...
      if ((prevResult == null ? void 0 : prevResult.isPlaceholderData) && options.placeholderData === (prevResultOptions == null ? void 0 : prevResultOptions.placeholderData)) {
        ...
        placeholderData = typeof options.placeholderData === "function" ? options.placeholderData((_a13 = __privateGet(this, _lastQueryWithDefinedData)) == null ? void 0 : _a13.state.data, __privateGet(this, _lastQueryWithDefinedData)) : options.placeholderData;
  ...
  return promise;
}, _shouldScheduleTimer = new WeakSet(), shouldScheduleTimer_fn = function(timeout) {
  ...
  if (__privateGet(this, _currentResult).isStale || !__privateMethod(this, _shouldScheduleTimer, shouldScheduleTimer_fn).call(this, staleTime))
    return;
  ...
  if (__privateGet(this, _currentRefetchInterval) === 0 || !__privateMethod(this, _shouldScheduleTimer, shouldScheduleTimer_fn).call(this, __privateGet(this, _currentRefetchInterval)))
    return;
...
var Mutation = (_a7 = class extends Removable {
  ...
  async execute(variables) {
    ...
    try {
      ...
      if (__privateGet(this, _retryer2) === retryer)
        __privateSet(this, _retryer2, void 0);
...
var MutationCache = (_a8 = class extends Subscribable {
  ...
  runNext(mutation) {
    ...
    const scope = scopeFor(mutation);
    if (typeof scope === "string")
      return ((_b = (_a13 = __privateGet(this, _scopes).get(scope)) == null ? void 0 : _a13.find((m) => m !== mutation && m.state.isPaused)) == null ? void 0 : _b.continue()) ?? Promise.resolve();
    else
...
var _client4, _currentResult2, _currentMutation, _mutateOptions, _updateResult, updateResult_fn, _notify, notify_fn, _a9;
...
var _client5, _result, _queries, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _lastQueryHashes, _observerMatches, _trackResult, trackResult_fn, _combineResult, combineResult_fn, _shouldSkipCombine, shouldSkipCombine_fn, _findMatchingObservers, findMatchingObservers_fn, _onUpdate, onUpdate_fn, _notify2, notify_fn2, _a10;
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  if (this.hasListeners()) {
    ...
    const newResult = shouldSkipCombine ? previousResult : __privateMethod(this, _combineResult, combineResult_fn).call(this, __privateMethod(this, _trackResult, trackResult_fn).call(this, __privateGet(this, _result), __privateGet(this, _observerMatches)), (_a13 = __privateGet(this, _options)) == null ? void 0 : _a13.combine);
  ...
  const hydrationQueue = React2.useMemo(() => {
    if (state) {
      ...
      for (const dehydratedQuery of queries) {
        ...
        else if (dehydratedQuery.state.dataUpdatedAt > existingQuery.state.dataUpdatedAt || dehydratedQuery.promise && existingQuery.state.status !== "pending" && existingQuery.state.fetchStatus !== "fetching" && dehydratedQuery.dehydratedAt !== void 0 && dehydratedQuery.dehydratedAt > existingQuery.state.dataUpdatedAt)
...
function usePrefetchQuery(options, queryClient) {
  ...
  if (!client.getQueryState(options.queryKey))
    client.query(options).catch(noop);
}
...
function usePrefetchInfiniteQuery(options, queryClient) {
  const client = useQueryClient(queryClient);
  if (!client.getQueryState(options.queryKey))
    client.infiniteQuery(options).catch(noop);
}
